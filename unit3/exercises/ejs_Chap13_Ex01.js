/**********************************************************************
**
**  Eloquent JavaScript - Chapter 5:  The Document Object Model
**
...
**  <tr> tags, we can put cell elements: either heading cells (<th>)
**  or regular cells (<td>).
**  
**  The same source data that was used in Chapter 6 is again available
**  in the MOUNTAINS variable in the sandbox. It can also be downloaded
**  from the website.
**  
...
**  property names wrapped in <th> elements and should have one
**  subsequent row per object in the array, with its property values in
**  <td> elements.
**  
...
**  
**  Once you have the basics working, right-align cells containing
**  numbers by setting their style.textAlign property to "right".
**  
**    <style>
